...
def extract_corresponding_fasttext_embeddings(pkl_data, data_dict, output_filepath):
    ...
    print(words_in_fasttext, "corresponding words found in FastText out of", total, "words in our set:",     words_not_in_fasttext*100/total, "percent and found", len(in_fasttext_set), "unique words")
...
if __name__ == "__main__":
    ...
    train_outfile = "./../data/train_fasttext.pkl"
    dev_outfile = "./../data/dev_fasttext.pkl"
    test_outfile = "./../data/test_fasttext.pkl"

    extract_corresponding_fasttext_embeddings(pkl_data = train_pkl,data_dict=data_dict,output_filepath = train_outfile)
    extract_corresponding_fasttext_embeddings(pkl_data = dev_pkl,data_dict=data_dict,output_filepath = dev_outfile)
    extract_corresponding_fasttext_embeddings(pkl_data = test_pkl,data_dict=data_dict,output_filepath = test_outfile)