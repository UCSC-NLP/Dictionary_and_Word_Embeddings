...
def extract_corresponding_glove_embeddings(pkl_data, embed_dict, output_filepath):
...
if __name__ == "__main__":
    ...
    download_glove_model(download_url=glove_url, filename=filename)

    embed_dict = make_glove_dictionary()

    train_outfile = "./../data/train.pkl"
    dev_outfile = "./../data/dev.pkl"
    test_outfile = "./../data/test.pkl"

    extract_corresponding_glove_embeddings(pkl_data = train_pkl,embed_dict=embed_dict,output_filepath = train_outfile)
    extract_corresponding_glove_embeddings(pkl_data = dev_pkl,embed_dict=embed_dict,output_filepath = dev_outfile)
    extract_corresponding_glove_embeddings(pkl_data = test_pkl,embed_dict=embed_dict,output_filepath = test_outfile)
